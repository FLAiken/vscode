...
import { AbstractIncrementalTestCollection, ICallProfileRunHandler, IncrementalTestCollectionItem, InternalTestItem, ITestItemContext, ResolvedTestRunRequest, RunTestForControllerRequest, RunTestForControllerResult, TestItemExpandState, TestRunProfileBitset, TestsDiff } from 'vs/workbench/contrib/testing/common/testTypes';
...
export interface IMainThreadTestController {
	...
	startContinuousRun(request: ICallProfileRunHandler[], token: CancellationToken): Promise<RunTestForControllerResult[]>;
